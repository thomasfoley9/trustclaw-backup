...
export interface RunAgentInput {
  ...
  // Live voice calls pin the persona captured at dispatch. Declared here so
  // that if the voice path ever moves onto this seam the pin travels with it
  // instead of silently dropping (prepareAgentRun's params are optional).
