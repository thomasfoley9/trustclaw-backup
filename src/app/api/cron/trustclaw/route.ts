...
// running gets its lock reclaimed and dispatched a second time concurrently.
...
export async function GET(request: Request) {
  ...
  // forever in run history. Runs self-abort at RUN_WALL_CLOCK_MS (720s), so
  // anything still "running" past the 15-min lock timeout is dead - mark it
  // failed.
