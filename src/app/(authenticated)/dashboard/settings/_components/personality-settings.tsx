...
import { useVoiceCallStore } from "~/app/(authenticated)/dashboard/_components/chat/voice-call-store";
...
export function PersonalitySettings() {
  ...
  // A live call's spoken voice is fixed at dispatch and can't be changed
  // mid-session, so switching during one only takes effect on the next call.
                        ...
                        onClick={() => {
                          ...
                          void setActiveMutation
                            ...
                            .then(() => {
                              if (duringCall) {
                                showInfoToast(
                                  `The voice on this call won't change. ${personality.name} applies to your next call.`,
                                );
                              }
                            })
                            .catch(() => undefined); // onError already toasts
                        }}
                      >
